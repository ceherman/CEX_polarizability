...
fig, ax = my_plot.instantiate_fig(fontsize=24)
plt.close()

fig, ax = plt.subplots(2, 1, sharex=True, sharey=True)
fig.set_size_inches(8, 16)
ax[0].set_title("CHARMM36", pad=-40)
ax[1].set_title("AMOEBA", pad=-40)
...
ax[0].legend(loc='center left', bbox_to_anchor=(0.96, 0.0), frameon=False, handletextpad=0.1)
plt.subplots_adjust(hspace=0.1)

plt.savefig('./images/volcano_tea_leaf_pmf_min_vertical.png', dpi=300, bbox_inches='tight')
plt.savefig('./images/volcano_tea_leaf_pmf_min_vertical.pdf', bbox_inches='tight')
