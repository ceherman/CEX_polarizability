...
amoeba_path = '/home/chase/namd/openmm/mqct/c_chemistry'
charmm_path = '/home/chase/namd/ion_pairs/cgenff/mqct_for_summit_tip/b_chemistry_with_charges'
...
for i, ion in enumerate(ions):
    ...
    df_amoeba = df_amoeba[df_amoeba['r'] > 2.0]
    df_charmm = df_charmm[df_charmm['r'] > 2.0]
...
plt.savefig(f'./images/chem_integrand.png', dpi=300, bbox_inches='tight')
plt.savefig(f'./images/chem_integrand.pdf', bbox_inches='tight')
