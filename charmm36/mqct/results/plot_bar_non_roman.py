...
ax[0].legend(handlelength=1.2, frameon=False, handletextpad=0.5, fontsize=20)
ax[3].legend(handlelength=1.2, frameon=False, handletextpad=0.5, loc='upper left', fontsize=20)
ax[0].set_ylim(-100, 40)

my_plot.set_layout(fig, ax)
plt.subplots_adjust(wspace=0.05)

plt.savefig('./images/bar_plot_non_roman.png', dpi=300, bbox_inches='tight')
plt.savefig('./images/bar_plot_non_roman.eps', bbox_inches='tight')
