...
#
#SBATCH --output=wbox_%x-%j.out
#SBATCH --error=wbox_%x-%j.out
#
...
#
${UD_MPIRUN} namd2 +idlepoll +p${SLURM_CPUS_ON_NODE} +devices ${CUDA_VISIBLE_DEVICES} equilibrate.namd > equilibrate.log
mpi_rc=$?
