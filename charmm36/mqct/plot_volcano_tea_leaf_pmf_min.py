...
plt.savefig('./images/volcano_tea_leaf_pmf_min.png', dpi=300, bbox_inches='tight')
plt.savefig('./images/volcano_tea_leaf_pmf_min.pdf', bbox_inches='tight')
plt.savefig('./images/volcano_tea_leaf_pmf_min.eps', bbox_inches='tight')
