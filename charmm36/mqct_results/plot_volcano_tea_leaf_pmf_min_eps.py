...
ax[0].set_ylabel(r'-1 $\times$ PMF min [kcal/mol]', labelpad=15)
for i in range(2):
...
# plt.savefig('./images/volcano_tea_leaf_pmf_min_eps.png', dpi=300, bbox_inches='tight')
# plt.savefig('./images/volcano_tea_leaf_pmf_min_eps.pdf', bbox_inches='tight')
plt.savefig('./images/volcano_tea_leaf_pmf_min_eps_2.eps', bbox_inches='tight')
