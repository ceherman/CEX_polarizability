...
#
#SBATCH --output=1_%x-%j.out
#SBATCH --error=1_%x-%j.out
#
...
#
${UD_MPIRUN} namd2 +idlepoll +p${SLURM_CPUS_ON_NODE} +devices ${CUDA_VISIBLE_DEVICES} sampling_1.namd > sampling_1.log
mpi_rc=$?
