...
#
#SBATCH --output=2_%x-%j.out
#SBATCH --error=2_%x-%j.out
#
...
#
${UD_MPIRUN} namd2 +idlepoll +p${SLURM_CPUS_ON_NODE} +devices ${CUDA_VISIBLE_DEVICES} sampling_2.namd > sampling_2.log
mpi_rc=$?
