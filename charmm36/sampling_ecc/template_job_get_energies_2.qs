...
#        name):
#
#SBATCH --job-name=E2xxx_name_xxx
#
...
#
#SBATCH --output=get_energies_%x-%j.out
#SBATCH --error=get_energies_%x-%j.out
#
...
pair=xxx_pair_xxx
i_anion=xxx_i_anion_xxx
for i_cation in {23..44}
do
    pair_dir=pair_${i_anion}_${i_cation}
    ${UD_MPIRUN} namd2 ${pair}/${pair_dir}/pair_pme_off_2.namd > ${pair}/${pair_dir}/pair_pme_off_2.log
    mpi_rc=$?
done
