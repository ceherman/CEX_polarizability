...
#
#SBATCH --output=0_%x-%j.out
#SBATCH --error=0_%x-%j.out
#
...
#
${UD_MPIRUN} namd2 +idlepoll +p${SLURM_CPUS_ON_NODE} +devices ${CUDA_VISIBLE_DEVICES} sampling_0.namd > sampling_0.log
mpi_rc=$?
