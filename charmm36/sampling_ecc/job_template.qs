...
#        name):
#
#SBATCH --job-name="xxx_job_name_xxx"
#
...
#
#SBATCH --output=xxx_i_xxx_%x-%j.out
#SBATCH --error=xxx_i_xxx_%x-%j.out
#
...
#
${UD_MPIRUN} namd2 +idlepoll +p${SLURM_CPUS_ON_NODE} +devices ${CUDA_VISIBLE_DEVICES} sampling_xxx_i_xxx.namd > sampling_xxx_i_xxx.log
mpi_rc=$?
