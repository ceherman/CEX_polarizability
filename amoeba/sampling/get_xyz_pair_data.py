...
anion = sys.argv[1]
cation = sys.argv[2]
resi_anion = sys.argv[3] # 1 to 22
resi_cation = sys.argv[4] # 23 to 44
...
manip_xyz.writetarcfile(f'./{output_dir}/{anion}_{resi_anion}_{cation}_{resi_cation}.arc', mol_combined, xyz_coord_combined)
