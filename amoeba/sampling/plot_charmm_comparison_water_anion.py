...
for show_rshell in [True, False]:
    ...
    for data in ['pmf', 'gr']:
        ...
        if show_rshell:
            fig.savefig(f'./images_v2_namd/charmm_comparison_water_anion_{data}_with_rshell.png', dpi=300)
        else:
            fig.savefig(f'./images_v2_namd/charmm_comparison_water_anion_{data}.png', dpi=300)
