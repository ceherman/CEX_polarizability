...
for j, anion in enumerate(['acet', 'esna', 'mso4']):
    ...
    for i, cation in enumerate(['guan', 'imim', 'mamm']):
        ...
        interp_columns = ['pmf', 'direct', 'w_solv'] # ['direct', 'elect', 'vdw', 'polar']
...
ax[0, 2].legend(handlelength=1, frameon=False, fontsize=12, loc='lower right', bbox_to_anchor=(1.04, -0.03))
plt.tight_layout()
plt.subplots_adjust(wspace=0.05, hspace=0.05)
fig.savefig(f'./images_v2_namd/energy_contributions_comparison_diff_bare.png', dpi=300)
