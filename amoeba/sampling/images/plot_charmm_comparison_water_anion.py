...
for data in ['pmf', 'gr']:
    ...
    fig.savefig(f'./images/charmm_comparison_water_anion_{data}.png', dpi=300, bbox_extra_artists=[st], bbox_inches='tight')
    fig.savefig(f'./images/charmm_comparison_water_anion_{data}.pdf', bbox_extra_artists=[st], bbox_inches='tight')
