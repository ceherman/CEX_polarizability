...
fig.savefig(f'./images/Ka_bar_plot_with_imim_app.eps', bbox_inches='tight')
fig.savefig(f'./images/Ka_bar_plot_with_imim_app.pdf', bbox_inches='tight')
fig.savefig(f'./images/Ka_bar_plot_with_imim_app.png', dpi=300, bbox_inches='tight')
