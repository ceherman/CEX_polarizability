...
data_names = [('pmf', 'PMF'), ('direct', r'$U_{Direct}$'), ('w_solv', r'$W_{Indirect}$'), ('elect', 'Elect.'), ('vdw', 'VdW')]
...
fig.savefig(f'./images_v2_namd/energy_contributions_comparison_all_pme_off.png', dpi=300)

ax[0, 0].set_xlim(2.8, 17)
ax[0, 0].set_ylim(-25, 15)
fig.savefig(f'./images_v2_namd/energy_contributions_comparison_all_pme_off_zoomed.png', dpi=300)
