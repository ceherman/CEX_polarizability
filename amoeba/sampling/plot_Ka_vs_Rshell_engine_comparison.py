...
fig.savefig(f'./images_v2_namd/Ka_vs_Rshell_engine_comparison_no_zoom.png', dpi=300)

ax[0, 0].set_ylim(0, 2.7)
ax[0, 0].set_xlim(3, 7.5)
fig.savefig(f'./images_v2_namd/Ka_vs_Rshell_engine_comparison.png', dpi=300)
