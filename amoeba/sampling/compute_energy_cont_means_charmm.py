...
for data_dir in ['acet_guan', 'acet_imim', 'acet_mamm', 'esna_guan', 'esna_imim', 'esna_mamm', 'mso4_guan', 'mso4_imim']:
    print(data_dir)
    df = pd.read_csv(f'./{data_dir}/pair_data_charmm/pairwise_ener_and_dist_pme_off.csv')
    ...
    df_means = pd.DataFrame({'r':r_vals, 'elect_mean':elect_mean,
                            ...
                            'vdw_seom':vdw_seom})
    df_means.to_csv(f'./{data_dir}/pair_data_charmm/pairwise_ener_means_pme_off.csv', index=False)
