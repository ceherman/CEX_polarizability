...
method = 'gr'
df = pd.read_csv(f'./results_Ka_{method}_tip.csv')
...
for k, engine in enumerate(['namd_tip', 'openmm']):
...
fig.savefig(f'./images_v3_tip/charmm_comparison_Ka_{method}.png', dpi=300)
