...
fig.supylabel(r'$\vert \; U_{\mathsf{CHARMM36}} - U_{\mathsf{AMOEBA}} \; \vert$ [kcal/mol]')
...
ax[0, 0].legend(handlelength=1, frameon=False, fontsize=16)
plt.tight_layout()
plt.subplots_adjust(wspace=0.05, hspace=0.05)
fig.savefig(f'./images_v2_namd/cross_ff_analysis_energy_cont_diff.png', dpi=300)
