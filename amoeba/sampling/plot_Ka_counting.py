...
# method = 'counting_difference_for_unassociated'
method = 'counting_direct'
...
fig.savefig(f'./images/charmm_comparison_Ka_{method}.png', dpi=300)
# fig.savefig(f'./images/charmm_comparison_Ka_{method}_yscaled.png', dpi=300)
